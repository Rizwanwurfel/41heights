...
<head>
  ...
  <title>41 Hieghts | All  orders</title>
...
<div class="wrapper">
 ...
 <?php 
		...
		$this->session->set_userdata('page','all_orders');
                  ...
                  <table id="example1" class="table table-bordered table-striped table-responsive">
					...
					$count=1;
                       ...
                       <tr id="<?php echo $row['order_id'];?>" <?php if ($row['seen_detail']==0){ echo "style='background:linear-gradient(45deg, rgba(254,187,187,1) 0%,rgba(254,186,186,1) 1%,rgba(254,150,150,0.3) 58%,rgba(254,144,144,0.3) 67%,rgba(255,92,92,0.3) 100%); ' " ;} ?>>
                        ...
                        <td><span <?php if($row['order_status']=="pending"){ echo "class='shake-little shake-constant' style='color:red'"; } ?>><?php echo $row['order_status'];?></td>
					...
					?>
                        <td><a  onclick="return confirm('Are you sure?')" href="<?php echo site_url('Order/delete_order_rec')?>/<?php echo $or_id;?>"><span class="glyphicon glyphicon-trash"></span></td>
                      </tr>
