...
<head>
  ...
  <title>41 Heights| Add product</title>
...
<div class="wrapper">
 ...
 <?php $this->load->view('admin/include/header');?>
  <?php 
		...
		$this->session->set_userdata('page','add_product');
		 ?>
    ...
    <section class="content">
      ...
      <div class="box">
		...
		?>
				...
				<form class="form-horizontal" action="<?php echo site_url('Product_p/add_product');?>" method="post"  enctype="multipart/form-data">
					  ...
					  <br>
					   <div class="input-group ">
							...
							<input type="text" name="product_name" id="product_name" required class="form-control" placeholder="Enter Product name">
					  ...
					  <br>
					     <div class="input-group ">
							...
							<textarea required placeholder="enter small description/note" name="product_desc" class="form-control" ></textarea>
					  </div>
					  <br>
					   <div class="input-group ">
							<span class="input-group-addon"><i class="fa fa-tag"> RS. </i></span>
						<input type="number" name="product_price" min="0" class="form-control" placeholder="Enter Product price">
					   ...
					   <br>
						 <div class="input-group ">
							...
							<span class="input-group-addon"><i class="fa fa-code-fork"> choose attribute</i></span>
							
						
							<select class="form-control" name="product_att">
					  ...
					  <div class="input-group ">
							...
							<input type="file" name="product_image" id="prodcut_image"  class="form-control">
					  </div>
