...
<head>
  ...
  <title>41Heights | All  pending orders</title>
          ...
          <!-- /.box -->
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					$count=1;
                       ...
                       <tr id="<?php echo $row['order_id'];?>" <?php if ($row['seen_detail']==0){ echo "style='background:linear-gradient(45deg, rgba(254,187,187,1) 0%,rgba(254,186,186,1) 1%,rgba(254,150,150,0.3) 58%,rgba(254,144,144,0.3) 67%,rgba(255,92,92,0.3) 100%); ' " ;} ?>>
						...
						<td><b style="color:blue"><?php echo $row['order_status'];?></b></td>
						<?php
					...
					?>
                        ...
                        <td style=""><a href="<?php echo site_url('Order/update_order_status/cancelled')?>/<?php echo $or_id;?>" class="text-red">Cancel</a> <br/><br/><a href="<?php echo site_url('Order/update_order_status/confirmed')?>/<?php echo $or_id;?>" class="text-blue">Confirmed</a> <br/> <br/><a href="<?php echo site_url('Order/update_order_status/delivered')?>/<?php echo $or_id;?>" class="text-green">delivered</a></td>
                     ...
                     <?php $count++; } } else { ?>
					 <center> <br><p style="">No Orders are there to display</p></center>
				  ...
				  <!--<div style="padding-top:3%">
						<a type="submit" class="btn btn-info" id="add_new_cat" data-modal-id="popup2">Add New category</a>
				  </div>-->
                </div><!-- /.box-body -->
              </div>
          <!-- /.box -->
