...
<div class="wrapper">
 ...
 <?php 
	...
	<!----------------sidebar-------------------------->
		...
		$this->session->set_userdata('slider_android','page2');
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">slide edit</h4>
						</div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:">Slider management</a></li>
        ...
        <div class="col-xs-12">
          ...
          <table id="example1" class="table table-bordered table-striped">
					...
					<?php
							if(!empty($all_slides)) {
					$count=1;
							foreach($all_slides->result_array() as $row){  ?>
                       <tr>
                        <td><?php echo $count;?></td>
                        <td><img src="<?php echo base_url();?>/<?php echo $row['slider_image'];?>"  width="150px" class="img-responsive" align="center"/></td>
                        ...
                        <td>
								...
								if($row['slider_disabled']==0)
								{
									echo "<b style='color:green'>Slide Enabled</b>";
								}
								else
								{
									echo "Slide Disabled";
                        ...
                        <td><a onClick="edit_slider(<?php echo $row['slider_id']; ?>)" style="cursor:pointer" href="#popup3" data-toggle="modal"> Edit</a></td>
                        <td>
						<?php
							if($row['slider_disabled']==0)
								{ ?>
							
							<a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="<?php echo site_url('slider/toggle_slider')?>/<?php echo $row['slider_id']?>/1">Disable slide</a>
							
						<?php } else{ ?>
							<a  class="btn btn-success" href="<?php echo site_url('slider/toggle_slider')?>/<?php echo $row['slider_id']?>/0">Enable slide</a>
						<?php } ?>
						</td>
                      </tr>
                     ...
                     <?php $count++; } } else { ?>
					 <center> <br><p style="color:red">No slider images </p></center>
