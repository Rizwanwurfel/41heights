...
<head>
  ...
  <title>41Heights | All main cat</title>
...
<div class="wrapper">
 ...
 <?php 
		...
		$this->session->set_userdata('page','all_cat');
	?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All main cat</li>
      </ol>
    </section>
		<?php 
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">ALL main categories</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<?php //var_dump($all_staff->result_array());?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url($row['cat_image'])?>"  width="60px" align="center"/></td>
				  <?php if($row['cat_icon']) {?>
					<td><center><img src="<?php echo base_url($row['cat_icon'])?>"  width="60px" align="center"/></center></td>
					<?php } else{ ?>
                  ...
                  <td><a onClick="edit_cat(<?php echo $row['cat_id']; ?>)" style="cursor:pointer" href="#popup3" data-toggle="modal"> Edit</a></td>
                  <td>
						<?php if( $this->session->userdata('user_role_emb')=="admin" ) { echo "-"; } else{ 
						
							$u_id=$this->encrypt->encode($row['cat_id']);
						 $u_id = strtr(
						$u_id,
						array(
							'+' => '.',
						...
						?>
								<a title="delete record" onclick="return confirm('Are you sure?')" href="<?php echo site_url('Cat_p/delete_cat')?>/<?php echo $u_id;?>"><span class="glyphicon glyphicon-trash"></span></td>
						<?php } ?>
			  </tr>
  		...
  		document.getElementById("detail_edit").innerHTML = "<center>Wait Loading..</center>";
			var user_id=d;
			 ...
			 // Create our XMLHttpRequest object
					...
					var url ="<?php echo site_url('Cat_p/edit_cat_display')?>/"+user_id;
				//	alert(url);
