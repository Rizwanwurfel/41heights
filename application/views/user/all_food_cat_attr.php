...
<head>
  ...
  <title>Uniscreen | food attributes</title>
...
<div class="wrapper">
 ...
 <?php 
		...
		$this->session->set_userdata('page','all_food_attr');
	?>
	...
	<!----------------sidebar-------------------------->
		...
		$this->session->unset_userdata('page','all_food_attr');
	?>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
                                       ...
                                       <form action="<?php echo site_url('Menu/add_attr_cat');?>" method="post"  enctype="multipart/form-data">
			...
			<?php //var_dump($all_staff->result_array());?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a onClick="edit_cat(<?php echo $row['f_att_id']; ?>)" style="cursor:pointer" href="#popup3" data-toggle="modal"> Edit</a></td>
                  <td>
						...
						?>
								<a title="delete record" onclick="return confirm('Are you sure?')" href="<?php echo site_url('Menu/delete_attr_cat')?>/<?php echo $u_id;?>"><span class="glyphicon glyphicon-trash"></span></td>
						<?php } ?>
			  </tr>
  		...
  		document.getElementById("detail_edit").innerHTML = "<center>Wait Loading..</center>";
			var user_id=d;
			 ...
			 // Create our XMLHttpRequest object
					...
					var url ="<?php echo site_url('Menu/edit_att_cat_display')?>/"+user_id;
				//	alert(url);
