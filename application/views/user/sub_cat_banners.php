...
<head>
  ...
  <title>Embroidery | All sub cat banners</title>
...
<div class="wrapper">
 ...
 <?php 
		...
		$this->session->set_userdata('page','sub_cat_banner');
	?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All sub cat banners</li>
      </ol>
    </section>
		<?php 
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Banners Edit</h4>
						</div>
			...
			<?php //var_dump($all_staff->result_array());?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>sub cat banner1</th>
                  <th>sub cat banner2</th>
                  <th>sub cat name</th>
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url($row['sub_cat_b1'])?>"  width="60px" align="center"/></td>
                  <td><img src="<?php echo base_url($row['sub_cat_b2'])?>"  width="60px" align="center"/></td>
  		...
  		document.getElementById("detail_edit").innerHTML = "<center>Wait Loading..</center>";
			var user_id=d;
			 ...
			 // Create our XMLHttpRequest object
					...
					var url ="<?php echo site_url('Product/edit_sub_cat_bnr_display')?>/"+user_id;
				//	alert(url);
