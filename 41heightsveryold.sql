...
CREATE TABLE IF NOT EXISTS `ambassador_order` (
  `amb_or_id` int(11) NOT NULL AUTO_INCREMENT,
  `amb_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `points_used` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`amb_or_id`)
...
CREATE TABLE IF NOT EXISTS `att_category` (
  `att_cat_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `att_name` (
  `att_name_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`att_name_id`),
  KEY `att_cat_id_fk` (`att_cat_id`)
...
CREATE TABLE IF NOT EXISTS `att_values` (
  `att_value_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `att_name_id_fk` (`att_name_id`)
...
CREATE TABLE IF NOT EXISTS `deals_products` (
  `deal_pr_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `order_description` (
  `order_desc_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rest_timing` (
  `time_d` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `slider` (`slider_id`, `slider_order`, `slider_image`, `slider_text`, `slider_disabled`) VALUES
(1, 1, 'public/slider/1/170516050038_1.png', 'faisal mosque', 0),
(2, 2, 'public/slider/2/bilal_14.jpg', '14 august', 1),
(4, 3, 'public/slider/4/isb.jpg', 'viewa islamabad', 0),
(5, 4, 'public/slider/5/medical-tourism-kerala.jpg', 'nice view', 0),
(6, 5, 'public/slider/6/trip.png', 'slider', 0);
...
(12, 'Bilal khans', 'bilal@gmail.com', '301fa1a42a5ccf979972d5917ca91b5a', 'public/uploads/bilal@gmail.com/23_02_17_04_55_09_deal.png', 'jinnah garden islamabad', '03331529878', 1, b'1', b'0', b'0', '2016-12-09 07:32:52'),
